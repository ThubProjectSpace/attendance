...
<li role="presentation" class="<?php if(isset($_POST['student_submit']) || $_POST[0]=='') echo 'active'; ?>"><a href="#student" aria-controls="home" role="tab" data-toggle="tab">Student Search</a></li>
                                       
 <li role="presentation" class="<?php if(isset($_POST['college_submit'])) echo 'active'; ?>"><a href="#college" aria-controls="profile" role="tab" data-toggle="tab">College Search</a></li>
                                        
<li role="presentation"><a href="#branch" aria-controls="messages" role="tab" data-toggle="tab">Branch Search</a></li>
...
<div role="tabpanel" class="tab-pane <?php if(isset($_POST['submit']) || !isset($_POST['submit'])) echo 'active'; ?>" id="student"><br> <br>  
 <div class="row">
<center>
 <form method="post">
...
<div role="tabpanel" class="tab-pane <?php if(isset($_POST['submit1'])) echo 'active'; ?>" id="college"> 
<div class="row">
<center>
 <form method="post">
<p>Select College: 
