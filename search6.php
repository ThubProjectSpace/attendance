...
<div class="container">
  ...
  <ul class="nav nav-tabs">
    <li class="<?php if( (isset($_POST['submit']) && isset($_POST['submit']) !== '')) echo '$_GET['studentsearch']'; else echo 'studentsearch';  
      # code...?>"><a data-toggle="tab" href="#studentsearch">Student Search</a></li>
    <li class="<?php if( (isset($_POST['submit1']) && isset($_POST['submit1']) !== '')) echo '$_GET['collegesearch']'; else echo 'studentsearch';  
      # code...?>"><a data-toggle="tab" href="#collegesearch">College Search</a></li>
    <li class="<?php if( (isset($_POST['submit2']) && isset($_POST['submit2']) !== '')) echo '$_GET['branchsearch']'; else echo 'studentsearch';  
      # code...?>"><a data-toggle="tab" href="#branchsearch">Branch Search</a></li>
   
  </ul>
<div id="studentsearch" style="padding:0">
</div>
  </h4>

  <div class="tab-content">
    <div id="studentsearch" class="tab-pane fade in active <?php if( (isset($_GET['studentsearch']) && isset($_GET['studentsearch']) !== '')) echo '$_GET['studentsearch']'; else echo 'collegesearch';  
      # code...
    ?>">
      <div class="row">
<center>
...
<div class="tab-content" style="border: 1px solid #eee; background: #fff; padding: 10px;">
     ...
     <div class="tab-content">
    <div id="collegesearch" class="tab-pane fade <?php if( (isset($_GET['collegesearch']) && isset($_GET['collegesearch']) !== '')) echo '$_GET['collegesearch']'; else echo 'studentsearch'; 
      # code...?>">
       <div class="row">
<center>
 <form method="post">
...
<div class="tab-content" style="border: 1px solid #eee; background: #fff; padding: 10px;">
 ...
 <div class="tab-content">
    <div id="branchsearch" class="tab-pane fade <?php if( (isset($_GET['collegesearch']) && isset($_GET['collegesearch']) !== '')) echo '$_GET['collegesearch']'; else echo 'studentsearch';  
      # code...?>">
      <div class="row">
<center>
 <form method="post">
