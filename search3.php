...
<div class="container">
  ...
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#studentsearch">Student Search</a></li>
    <li><a data-toggle="tab" href="#collegesearch">College Search</a></li>
    <li><a data-toggle="tab" href="#branchsearch">Branch Search</a></li>
   
  </ul></h4>

  <div class="tab-content">
    <div id="studentsearch" class="tab-pane fade in active">
      <div class="row">
<center>
 <form method="post">
...
<div class="tab-content" style="border: 1px solid #eee; background: #fff; padding: 10px;">
     ...
     <div class="tab-content">
    <div id="collegesearch" class="tab-pane fade">
       <div class="row">
<center>
 <form method="post">
<p>Select College: 
...
<div class="tab-content" style="border: 1px solid #eee; background: #fff; padding: 10px;">
 ...
 <div class="tab-content">
    <div id="branchsearch" class="tab-pane fade">
      <div class="row">
<center>
 <form method="post">
<p>Select Branch: 
