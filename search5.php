...
<div class="container">
  ...
  <ul class="nav nav-tabs">
    ...
    <li class="tab-pane fade in active"><a data-toggle="tab" href="#collegesearch">College Search</a></li>
    <li class="tab-pane fade"><a data-toggle="tab" href="#branchsearch">Branch Search</a></li>
